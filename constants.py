...
# 在庫状況アイコン
STOCK_AVAILABLE_ICON = ":material/check_circle:"
STOCK_LOW_ICON = ":material/warning:"
STOCK_OUT_ICON = ":material/cancel:"

# 在庫状況メッセージ
STOCK_AVAILABLE_MESSAGE = "在庫あります。"
STOCK_LOW_MESSAGE = "ご好評につき、在庫が残りわずかです。購入をご希望の場合、お早めにご注文をおすすめいたします。"
